  ...
  return (
    <footer className="w-full bg-[var(--paper)] border-t border-[var(--line)] py-12 mt-20 text-[var(--muted)] text-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-xs font-semibold">
            ...
            {isAdmin && <>
              <li><a href="/lessons" className="hover:text-[var(--ink)] transition-colors">บทเรียน & ไวยากรณ์</a></li>
              <li><a href="/quiz" className="hover:text-[var(--ink)] transition-colors">ศูนย์รวมแบบทดสอบ Quiz</a></li>
              <li><a href="/plan" className="hover:text-[var(--ink)] transition-colors">แผนอ่าน 25 นาที & ตัวจับเวลา</a></li>
            </>}
            <li>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 pt-6 border-t border-[var(--line)]/60 text-center text-xs">
        <p>&copy; 2026 HSK Studio. พัฒนาขึ้นเพื่อช่วยให้คนไทยเรียนภาษาจีนได้อย่างมั่นใจและมีประสิทธิภาพ</p>
      </div>
    </footer>
  );
}
